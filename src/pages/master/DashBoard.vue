          ...
          <div class="w-[calc(100%-30px)] flex">
            ...
            <div class="w-[200px] ">
              <div class="flex items-center justify-start space-x-4" @click="toggleDrop">
                <img class="w-10 h-10 rounded-full border-2 border-gray-800" src="../master/CvFotosu.jpeg" alt="">
                <div class="font-semibold dark:text-black text-left">
                  <div>Ahmet Çakıcı</div>
                  <div class="text-xs text-gray-500 dark:text-black">Admin</div>
                </div>
              </div>
              <!-- Drop down -->
